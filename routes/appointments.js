...
router.post('/', async (req, res) => {
    ...
    if (bodyIsEmpty(req.body)) {
      ...
      VALUES('${id_vehicle}', ${id_service}, '', '${pick_up_place}', '${pick_up_date}', 'No recogido', 'Pendiente', '${owner_notes}', '', '${delivery_place}', '${garage}');`;
...
router.put('/:appointmentID', async (req, res) => {
    if (bodyIsEmpty(req.body)) {
        ...
        const delivery_place = req.body.delivery_place;
        const garage = req.body.garage;
        queryExec = queryUse + `Update Appointment SET Appointment(id_vehicle, id_service, id_picker, pick_up_place, pick_up_date, appointment_status, appointment_request, owner_notes, picker_notes, delivery_place, garage) 
